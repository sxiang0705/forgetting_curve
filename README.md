...
- 下一次提醒操作：任務表格會顯示下一筆未完成提醒，並可直接完成或依個人化 snooze 偏好稍後提醒。
...
v8 目前完成現代 GUI 基礎、CSV 承接、新增任務、下一次提醒操作、個人化設定與資料層重構。舊版的圖表報表寄送、完整背景圖片管理與背景提醒彈窗，仍保留在 `curve.py` 舊版架構中，後續可逐步移植到 v8。
